...
require "addressable_savon/wsdl/request"
require "addressable_savon/wsdl/parser"

module AddressableSavon
  module WSDL

    # = AddressableSavon::WSDL::Document
    #
    ...
    private
      ...
      # Parses the WSDL document and returns the <tt>AddressableSavon::WSDL::Parser</tt>.
      def parser
        @parser ||= begin
