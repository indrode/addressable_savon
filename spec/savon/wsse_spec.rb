  ...
  describe "#to_xml" do
    ...
    context "with credentials" do
      ...
      it "contains the WSE and WSU namespaces" do
        wsse.to_xml.should include(AddressableSavon::WSSE::WSENamespace, AddressableSavon::WSSE::WSUNamespace)
      end
      ...
      it "contains the PasswordText type attribute" do
        wsse.to_xml.should include(AddressableSavon::WSSE::PasswordTextURI)
      end
    end
    ...
    context "with credentials and digest auth" do
      ...
      it "contains the PasswordDigest type attribute" do
        wsse.to_xml.should include(AddressableSavon::WSSE::PasswordDigestURI)
      end
    end
