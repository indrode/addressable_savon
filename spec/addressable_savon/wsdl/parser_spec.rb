...
describe AddressableSavon::WSDL::Parser do
  ...
  context "if the WSDL defines xs:schema without targetNamespace" do
    ...
    it "defaults to the target namespace from xs:definitions" do
      ...
      parser = AddressableSavon::WSDL::Parser.new(Nokogiri::XML(wsdl))
      parser.parse
  ...
  def new_parser(fixture)
    parser = AddressableSavon::WSDL::Parser.new(Nokogiri::XML(Fixture[:wsdl, fixture]))
    parser.parse
    parser
  end
